...
export const routine = {
	...
	namePlaceholder: 'Rutinens navn',
	descriptionPlaceholder: 'Beskrivelse (valgfrit)',
	goalPlaceholder: 'Mål, fx bevægelighed i hofterne',
	sectionPlaceholder: 'Afsnittets navn, fx Opvarmning',
	tagsPlaceholder: 'Tags, adskilt med komma',
	circuitHint: 'Cirkel — ét sæt af hver øvelse, så næste runde',
	removeExercise: 'Fjern øvelse',
	nameToSave: 'Giv rutinen et navn for at gemme den.',
	cancelEdit: '← Annullér',
	restLabelShort: 'Pause s',
	rangeTo: 'til',
